...
class TaskControllerValidationsTest extends AbstractContainerBase {
    ...
    void givenTaskWithoutName_whenCreate_thenReturnError404() {
        ...
        this.getValidationErrorResponse(EnumLanguageCode.EN)
                .value(errorDetailsDTO -> {
                    Assertions.assertThat(errorDetailsDTO.getErrorCode()).isEqualTo(EnumValidationError.FIELD_VALIDATION_ERROR.getCode());
    ...
    void givenTaskWithoutName_whenCreate_thenReturnError404InSpanish() {
        taskOperationDto.setOperation(EnumTaskOperation.CREATE);
        taskOperationDto.getTask().setName(null);
        this.getValidationErrorResponse(EnumLanguageCode.ES)
                .value(errorDetailsDTO -> {
                    Assertions.assertThat(errorDetailsDTO.getErrorCode()).isEqualTo(EnumValidationError.FIELD_VALIDATION_ERROR.getCode());
    ...
    @NotNull
    private WebTestClient.BodySpec<ErrorDetailsDto, ?> getValidationErrorResponse(EnumLanguageCode languageEnum) {
